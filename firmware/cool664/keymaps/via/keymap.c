...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_NO, KC_PPLS,    KC_PMNS,    KC_PAST,    KC_PSLS,    KC_PEQL,KC_3,KC_4,    KC_GRV,    KC_JYEN,    RSFT(KC_LBRC),   RSFT(KC_RBRC),  RSFT(KC_MINS), KC_RSFT,
  KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_SPACE,LT(_LOWER,KC_SPACE),KC_1, KC_2,LT(_RAISE,KC_SPACE),KC_SPACE, KC_RCTL,KC_LEFT, KC_DOWN, KC_RIGHT
  ) ,
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_NO, RGB_TOG,    RGB_MOD,    RGB_HUI,    RGB_HUD,    RGB_SAI,KC_3,KC_4,    RGB_SAD,    RGB_VAI,    KC_LBRC,   KC_RBRC,  KC_BSLASH, KC_RSFT,
KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_SPACE,LT(_LOWER,KC_SPACE),KC_1, KC_2,LT(_RAISE,KC_SPACE),KC_SPACE, KC_RCTL,KC_LEFT, KC_DOWN, KC_RIGHT
  ) 
};
