...
|6|スイッチプレート|１枚|アクリル|Elecrow|５枚で45ドル（キャンペーン価格、送料込み）|
||ミドルプレート|４枚|アクリル|Elecrow|↑同じ|
||ボトムプレート|３枚（大１、小２）|アクリル|Elecrow|↑同じ|
|7|スイッチソケット|pcb１枚につき32個|MX|[遊舎工房](https://shop.yushakobo.jp)<br>[TALP keyboard](https://talpkeyboard.net)|10個で165円（税込）|
|8|ダイオード|pcb１枚につき32個|リードタイプ、SMDのどちらでも可|[遊舎工房](https://shop.yushakobo.jp)<br>[TALP keyboard](https://talpkeyboard.net)|100個で220円（税込）|
|9|リセットスイッチ|PCBにつき１個|タクタイルスイッチとも呼ばれる|[遊舎工房](https://shop.yushakobo.jp)<br>[TALP keyboard](https://talpkeyboard.net)|1個で11円（税込）|
|10|MXスイッチ|PCB１枚につき32個||[遊舎工房](https://shop.yushakobo.jp)<br>[TALP keyboard](https://talpkeyboard.net)等|1個で100円前後|
|11|キーキャップ|PCB１枚につき32個||[遊舎工房](https://shop.yushakobo.jp)<br>[TALP keyboard](https://talpkeyboard.net)|1個で100円前後<br>キーキャップセットで3000円程度から|
...
|17|ロータリーエンコーダー|最大２個|装着可能|[遊舎工房](https://shop.yushakobo.jp)<br>[TALP keyboard](https://talpkeyboard.net)等|400円程度から|
...
左右のPCBの一番内側に、キースイッチの代わりに、ロータリーエンコーダー２個まで取り付けることができます。
<br>
その場合、cool664rとなります。※firmwareは未整備です。
<br>
<br>
...
## 8 LEDの装着（任意）
cool664はフルカラーシリアルLEDテープを、PCB下面に装着することができます。
<br>
PCB下面を表側にしておきます。
...
## 9 ファームウェア
cool664は一つでマクロパッドとして、二つで分割キーボード（または一体型キーボード）として設計されました。
そのため、複数のファームウェアが必要となります。
<br>
ただ、分割キーボード用のファームウェアをマクロパッドとしてのcool664に入れても、問題なく動作します。
<br>
...
[cool664の場合](https://remap-keys.app/catalog/Z8IwB4S7abAjZKmw3VmG/firmware)
<br>

ロータリーエンコーダー付きのcool64の場合
<br>

[ここに](https://github.com/telzo2000/cool664/tree/main/firmware)
firawareがありますので、ご自由にお使いください。
<br>
<br>
...
<br>
次に、スイッチプレートの上面からキースイッチを挿しこみ、反対側からPCBのスイッチソケットで受けてください。<br>
アクリル加工の性質上、交差があります。うまくスイッチソケット等が入らない時は、やすり等でスイッチ穴の修正をしてください。<br>
